  ...
  13:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  int i;
  int pid = getpid();
  1b:	e8 42 03 00 00       	call   362 <getpid>

  int syscall_id = atoi(argv[1]);
  20:	83 ec 0c             	sub    $0xc,%esp
  23:	ff 76 04             	pushl  0x4(%esi)
  int pid = getpid();
  26:	89 c3                	mov    %eax,%ebx
  int syscall_id = atoi(argv[1]);
  28:	e8 43 02 00 00       	call   270 <atoi>
  ...
  31:	56                   	push   %esi
  32:	53                   	push   %ebx
  33:	e8 62 03 00 00       	call   39a <trace>
  printf(2, "pid: %d   syscallid: %d   trace: %d\n", pid, syscall_id, traceresult);
  38:	89 04 24             	mov    %eax,(%esp)
  3b:	56                   	push   %esi
  3c:	53                   	push   %ebx
  3d:	68 cc 07 00 00       	push   $0x7cc

  for (i = 0; i < 10; i++) {
  42:	31 db                	xor    %ebx,%ebx
  printf(2, "pid: %d   syscallid: %d   trace: %d\n", pid, syscall_id, traceresult);
  44:	6a 02                	push   $0x2
  46:	e8 05 04 00 00       	call   450 <printf>
  ...
  53:	56                   	push   %esi
  54:	53                   	push   %ebx
  55:	e8 40 03 00 00       	call   39a <trace>
    printf(2, "pid: %d   syscallid: %d   trace: %d\n", pid, syscall_id, traceresult);
  5a:	89 04 24             	mov    %eax,(%esp)
  5d:	56                   	push   %esi
  5e:	53                   	push   %ebx
  5f:	68 cc 07 00 00       	push   $0x7cc
  for (i = 0; i < 10; i++) {
  ...
  7b:	51                   	push   %ecx
  7c:	51                   	push   %ecx
  7d:	68 a8 07 00 00       	push   $0x7a8
  82:	6a 02                	push   $0x2
  84:	e8 c7 03 00 00       	call   450 <printf>
    exit();
  89:	e8 54 02 00 00       	call   2e2 <exit>
  8e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb f4 07 00 00       	mov    $0x7f4,%ebx
        while(*s != 0){
 ...
 621:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 a8 0a 00 00       	mov    %eax,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 a8 0a 00 00    	cmp    %eax,0xaa8
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 a8 0a 00 00 ac 	movl   $0xaac,0xaa8
 777:	0a 00 00 
 77a:	c7 05 ac 0a 00 00 ac 	movl   $0xaac,0xaac
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 ac 0a 00 00       	mov    $0xaac,%eax
 789:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 790:	00 00 00 
