...
_trace: formato do arquivo elf32-i386
  ...
  13:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  if(argc < 2){
  19:	0f 8e 7c 00 00 00    	jle    9b <main+0x9b>
  ...
  1f:	e8 5e 03 00 00       	call   382 <getpid>

  int syscall_id = atoi(argv[1]);
  24:	83 ec 0c             	sub    $0xc,%esp
  27:	ff 76 04             	pushl  0x4(%esi)
  int pid = getpid();      // get the id of the current process running on terminal
  2a:	89 c3                	mov    %eax,%ebx
  int syscall_id = atoi(argv[1]);
  2c:	e8 5f 02 00 00       	call   290 <atoi>
  ...
  35:	56                   	push   %esi
  36:	53                   	push   %ebx
  37:	e8 7e 03 00 00       	call   3ba <trace>
  ...
  50:	53                   	push   %ebx
  51:	e8 4c 03 00 00       	call   3a2 <getpriority>
  getpriority(pid);
  56:	89 1c 24             	mov    %ebx,(%esp)
  59:	e8 44 03 00 00       	call   3a2 <getpriority>
  getpriority(pid);
  ...
  getpriority(pid);
  63:	e8 3a 03 00 00       	call   3a2 <getpriority>
  ...
  73:	56                   	push   %esi
  74:	53                   	push   %ebx
  75:	e8 40 03 00 00       	call   3ba <trace>
    printf(2, "pid: %d   syscallid: %d   trace: %d\n", pid, syscall_id, traceresult);
  7a:	89 04 24             	mov    %eax,(%esp)
  7d:	56                   	push   %esi
  7e:	53                   	push   %ebx
  7f:	68 e4 07 00 00       	push   $0x7e4
  for (i = 0; i < 10; i++) {
  84:	83 c3 01             	add    $0x1,%ebx
    printf(2, "pid: %d   syscallid: %d   trace: %d\n", pid, syscall_id, traceresult);
  87:	6a 02                	push   $0x2
  89:	e8 e2 03 00 00       	call   470 <printf>
  for (i = 0; i < 10; i++) {
  8e:	83 c4 20             	add    $0x20,%esp
  91:	83 fb 0a             	cmp    $0xa,%ebx
  ...
  exit();
  96:	e8 67 02 00 00       	call   302 <exit>
    printf(2, "usage: trace syscall_id\n");
  9b:	51                   	push   %ecx
  9c:	51                   	push   %ecx
  9d:	68 c8 07 00 00       	push   $0x7c8
  a2:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb 0c 08 00 00       	mov    $0x80c,%ebx
        while(*s != 0){
