...
_usage: formato do arquivo elf32-i386
...
main(int argc, char **argv) {
  ...
  3a:	e8 33 03 00 00       	call   372 <getusage>
  3f:	50                   	push   %eax
  40:	56                   	push   %esi
  41:	68 a2 07 00 00       	push   $0x7a2
  46:	6a 02                	push   $0x2
  48:	e8 e3 03 00 00       	call   430 <printf>
  for (i = 1; i < argc; ++i) {
  4d:	83 c4 20             	add    $0x20,%esp
  50:	39 fb                	cmp    %edi,%ebx
  52:	75 d4                	jne    28 <main+0x28>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb b9 07 00 00       	mov    $0x7b9,%ebx
        while(*s != 0){
