...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 6b 7e 10 80 	movl   $0x80107e6b,(%esp)
...
80101ed8:	68 52 7c 10 80       	push   $0x80107c52
...
80102332:	81 fb 68 82 11 80    	cmp    $0x80118268,%ebx
...
80102ec7:	68 68 82 11 80       	push   $0x80118268
...
8010362c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103630:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103636:	81 fb 14 7a 11 80    	cmp    $0x80117a14,%ebx
8010363c:	0f 83 a6 00 00 00    	jae    801036e8 <allocproc+0xd8>
    if(p->state == UNUSED)
...
8010365b:	89 43 10             	mov    %eax,0x10(%ebx)
  p->priority = random_at_most(31);    //default
8010365e:	6a 1f                	push   $0x1f
  p->pid = nextpid++;
80103660:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  p->priority = random_at_most(31);    //default
80103666:	e8 25 3e 00 00       	call   80107490 <random_at_most>
8010366b:	89 43 7c             	mov    %eax,0x7c(%ebx)
  p->schedulepriority = p->priority;
8010366e:	89 83 04 01 00 00    	mov    %eax,0x104(%ebx)
  p->usage = 0;
  p->tickets = 1000 - p->priority * p->priority ;
80103674:	ba e8 03 00 00       	mov    $0x3e8,%edx
80103679:	0f af c0             	imul   %eax,%eax
  p->usage = 0;
8010367c:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80103683:	00 00 00 
  p->tickets = 1000 - p->priority * p->priority ;
80103686:	29 c2                	sub    %eax,%edx
80103688:	89 93 08 01 00 00    	mov    %edx,0x108(%ebx)


  release(&ptable.lock);
8010368e:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103695:	e8 c6 0f 00 00       	call   80104660 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010369a:	e8 31 ee ff ff       	call   801024d0 <kalloc>
8010369f:	83 c4 10             	add    $0x10,%esp
801036a2:	85 c0                	test   %eax,%eax
801036a4:	89 43 08             	mov    %eax,0x8(%ebx)
801036a7:	74 58                	je     80103701 <allocproc+0xf1>
    return 0;
  }
...
801036b7:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801036ba:	c7 40 14 8c 5a 10 80 	movl   $0x80105a8c,0x14(%eax)
  p->context = (struct context*)sp;
...
801036c9:	e8 e2 0f 00 00       	call   801046b0 <memset>
...
801036eb:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036ed:	68 e0 36 11 80       	push   $0x801136e0
801036f2:	e8 69 0f 00 00       	call   80104660 <release>
}
...
8010370a:	eb cf                	jmp    801036db <allocproc+0xcb>
...
80103713:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103716:	68 e0 36 11 80       	push   $0x801136e0
...
8010376b:	68 e0 36 11 80       	push   $0x801136e0
...
8010378c:	e8 af ef ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103791:	8b 35 c0 36 11 80    	mov    0x801136c0,%esi
80103797:	85 f6                	test   %esi,%esi
80103799:	7e 42                	jle    801037dd <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010379b:	0f b6 15 40 31 11 80 	movzbl 0x80113140,%edx
801037a2:	39 d0                	cmp    %edx,%eax
801037a4:	74 30                	je     801037d6 <mycpu+0x56>
801037a6:	b9 f0 31 11 80       	mov    $0x801131f0,%ecx
  for (i = 0; i < ncpu; ++i) {
...
801037ca:	05 40 31 11 80       	add    $0x80113140,%eax
}
...
801037d5:	c3                   	ret    
    if (cpus[i].apicid == apicid)
801037d6:	b8 40 31 11 80       	mov    $0x80113140,%eax
      return &cpus[i];
...
801037ed:	68 18 7b 10 80       	push   $0x80107b18
...
8010380b:	2d 40 31 11 80       	sub    $0x80113140,%eax
}
80103810:	c9                   	leave  
  return mycpu()-cpus;
...
80103863:	e8 f8 37 00 00       	call   80107060 <setupkvm>
...
8010387b:	68 64 a4 10 80       	push   $0x8010a464
80103880:	50                   	push   %eax
80103881:	e8 ba 34 00 00       	call   80106d40 <inituvm>
...
80103896:	e8 15 0e 00 00       	call   801046b0 <memset>
...
801038f5:	e8 96 0f 00 00       	call   80104890 <safestrcpy>
  p->cwd = namei("/");
...
80103906:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103909:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103910:	e8 8b 0c 00 00       	call   801045a0 <acquire>
  p->state = RUNNABLE;
80103915:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
8010391c:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103923:	e8 38 0d 00 00       	call   80104660 <release>
}
...
80103945:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103948:	e8 83 0b 00 00       	call   801044d0 <pushcli>
  c = mycpu();
8010394d:	e8 2e fe ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103952:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103958:	e8 b3 0b 00 00       	call   80104510 <popcli>
  if(n > 0){
...
8010396c:	e8 bf 32 00 00       	call   80106c30 <switchuvm>
  return 0;
...
8010398a:	e8 f1 34 00 00       	call   80106e80 <allocuvm>
...
801039aa:	e8 01 36 00 00       	call   80106fb0 <deallocuvm>
...
80103a47:	89 44 b7 28          	mov    %eax,0x28(%edi,%esi,4)
  for(i = 0; i < NOFILE; i++)
...
80103a71:	e8 1a 0e 00 00       	call   80104890 <safestrcpy>
  pid = np->pid;
80103a76:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a79:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103a80:	e8 1b 0b 00 00       	call   801045a0 <acquire>
  np->state = RUNNABLE;
80103a85:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a8c:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103a93:	e8 c8 0b 00 00       	call   80104660 <release>
80103a98:	8d 97 84 00 00 00    	lea    0x84(%edi),%edx
80103a9e:	8d 8f 04 01 00 00    	lea    0x104(%edi),%ecx
80103aa4:	83 c4 10             	add    $0x10,%esp
80103aa7:	89 f6                	mov    %esi,%esi
80103aa9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    np->mapcalls[i] = 0;
80103ab0:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
80103ab6:	83 c2 04             	add    $0x4,%edx
  for (int i = 0; i < 32; ++i)
80103ab9:	39 d1                	cmp    %edx,%ecx
80103abb:	75 f3                	jne    80103ab0 <fork+0xf0>
}
80103abd:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103ac0:	89 d8                	mov    %ebx,%eax
80103ac2:	5b                   	pop    %ebx
80103ac3:	5e                   	pop    %esi
80103ac4:	5f                   	pop    %edi
80103ac5:	5d                   	pop    %ebp
80103ac6:	c3                   	ret    
    return -1;
80103ac7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103acc:	eb ef                	jmp    80103abd <fork+0xfd>
    kfree(np->kstack);
80103ace:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103ad1:	83 ec 0c             	sub    $0xc,%esp
80103ad4:	ff 73 08             	pushl  0x8(%ebx)
80103ad7:	e8 44 e8 ff ff       	call   80102320 <kfree>
    np->kstack = 0;
80103adc:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103ae3:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103aea:	83 c4 10             	add    $0x10,%esp
80103aed:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103af2:	eb c9                	jmp    80103abd <fork+0xfd>
...
80103b1d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  asm volatile("sti");
80103b20:	fb                   	sti    
    int totalTickets = 0;
...
80103b34:	75 06                	jne    80103b3c <scheduler+0x3c>
      totalTickets = totalTickets + p->tickets;  
80103b36:	03 90 08 01 00 00    	add    0x108(%eax),%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b3c:	05 0c 01 00 00       	add    $0x10c,%eax
80103b41:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
80103b46:	72 e8                	jb     80103b30 <scheduler+0x30>
    long winner = random_at_most(totalTickets);
80103b48:	83 ec 0c             	sub    $0xc,%esp
    int tickets_passed = 0;
80103b4b:	31 db                	xor    %ebx,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b4d:	bf 14 37 11 80       	mov    $0x80113714,%edi
    long winner = random_at_most(totalTickets);
80103b52:	52                   	push   %edx
80103b53:	e8 38 39 00 00       	call   80107490 <random_at_most>
    acquire(&ptable.lock);
80103b58:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
    long winner = random_at_most(totalTickets);
80103b5f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    acquire(&ptable.lock);
80103b62:	e8 39 0a 00 00       	call   801045a0 <acquire>
80103b67:	83 c4 10             	add    $0x10,%esp
80103b6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->state != RUNNABLE)
80103b70:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103b74:	75 47                	jne    80103bbd <scheduler+0xbd>
      tickets_passed += p->tickets;
80103b76:	03 9f 08 01 00 00    	add    0x108(%edi),%ebx
      if(tickets_passed < winner){
80103b7c:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
80103b7f:	7f 3c                	jg     80103bbd <scheduler+0xbd>
      switchuvm(p);
80103b81:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103b84:	89 be ac 00 00 00    	mov    %edi,0xac(%esi)
      switchuvm(p);
80103b8a:	57                   	push   %edi
80103b8b:	e8 a0 30 00 00       	call   80106c30 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103b90:	58                   	pop    %eax
80103b91:	5a                   	pop    %edx
80103b92:	ff 77 1c             	pushl  0x1c(%edi)
80103b95:	ff 75 e0             	pushl  -0x20(%ebp)
      p->state = RUNNING;
80103b98:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      p->usage++;
80103b9f:	83 87 80 00 00 00 01 	addl   $0x1,0x80(%edi)
      swtch(&(c->scheduler), p->context);
80103ba6:	e8 40 0d 00 00       	call   801048eb <swtch>
      switchkvm();
80103bab:	e8 60 30 00 00       	call   80106c10 <switchkvm>
      c->proc = 0;
80103bb0:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103bb7:	00 00 00 
80103bba:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bbd:	81 c7 0c 01 00 00    	add    $0x10c,%edi
80103bc3:	81 ff 14 7a 11 80    	cmp    $0x80117a14,%edi
80103bc9:	72 a5                	jb     80103b70 <scheduler+0x70>
    release(&ptable.lock);
80103bcb:	83 ec 0c             	sub    $0xc,%esp
80103bce:	68 e0 36 11 80       	push   $0x801136e0
80103bd3:	e8 88 0a 00 00       	call   80104660 <release>
  for(;;){
80103bd8:	83 c4 10             	add    $0x10,%esp
80103bdb:	e9 40 ff ff ff       	jmp    80103b20 <scheduler+0x20>
...
80103be4:	53                   	push   %ebx
  pushcli();
80103be5:	e8 e6 08 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80103bea:	e8 91 fb ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103bef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bf5:	e8 16 09 00 00       	call   80104510 <popcli>
  if(!holding(&ptable.lock))
80103bfa:	83 ec 0c             	sub    $0xc,%esp
80103bfd:	68 e0 36 11 80       	push   $0x801136e0
80103c02:	e8 69 09 00 00       	call   80104570 <holding>
...
80103c43:	e8 a3 0c 00 00       	call   801048eb <swtch>
  mycpu()->intena = intena;
...
80103ca6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ca9:	e8 22 08 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80103cae:	e8 cd fa ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103cb3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103cb9:	e8 52 08 00 00       	call   80104510 <popcli>
  if(curproc == initproc)
...
80103d04:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d0b:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103d12:	e8 89 08 00 00       	call   801045a0 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d1d:	b8 14 37 11 80       	mov    $0x80113714,%eax
80103d22:	eb 10                	jmp    80103d34 <exit+0x94>
80103d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d28:	05 0c 01 00 00       	add    $0x10c,%eax
80103d2d:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
...
80103d3f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d46:	05 0c 01 00 00       	add    $0x10c,%eax
80103d4b:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
80103d50:	72 e2                	jb     80103d34 <exit+0x94>
      p->parent = initproc;
80103d52:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d58:	ba 14 37 11 80       	mov    $0x80113714,%edx
80103d5d:	eb 0f                	jmp    80103d6e <exit+0xce>
80103d5f:	90                   	nop
80103d60:	81 c2 0c 01 00 00    	add    $0x10c,%edx
80103d66:	81 fa 14 7a 11 80    	cmp    $0x80117a14,%edx
...
80103d7a:	75 e4                	jne    80103d60 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d7c:	b8 14 37 11 80       	mov    $0x80113714,%eax
80103d81:	eb 11                	jmp    80103d94 <exit+0xf4>
80103d83:	90                   	nop
80103d84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d88:	05 0c 01 00 00       	add    $0x10c,%eax
80103d8d:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
...
80103db7:	68 bd 7a 10 80       	push   $0x80107abd
80103dbc:	e8 cf c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103dc1:	83 ec 0c             	sub    $0xc,%esp
80103dc4:	68 b0 7a 10 80       	push   $0x80107ab0
...
80103dd7:	68 e0 36 11 80       	push   $0x801136e0
80103ddc:	e8 bf 07 00 00       	call   801045a0 <acquire>
  pushcli();
80103de1:	e8 ea 06 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80103de6:	e8 95 f9 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103deb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103df1:	e8 1a 07 00 00       	call   80104510 <popcli>
  myproc()->state = RUNNABLE;
80103df6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103dfd:	e8 de fd ff ff       	call   80103be0 <sched>
  release(&ptable.lock);
80103e02:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103e09:	e8 52 08 00 00       	call   80104660 <release>
}
...
80103e2c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e2f:	e8 9c 06 00 00       	call   801044d0 <pushcli>
  c = mycpu();
80103e34:	e8 47 f9 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103e39:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e3f:	e8 cc 06 00 00       	call   80104510 <popcli>
  if(p == 0)
...
80103e50:	81 fe e0 36 11 80    	cmp    $0x801136e0,%esi
80103e56:	74 50                	je     80103ea8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103e58:	83 ec 0c             	sub    $0xc,%esp
80103e5b:	68 e0 36 11 80       	push   $0x801136e0
80103e60:	e8 3b 07 00 00       	call   801045a0 <acquire>
    release(lk);
80103e65:	89 34 24             	mov    %esi,(%esp)
80103e68:	e8 f3 07 00 00       	call   80104660 <release>
  p->chan = chan;
...
80103e7c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103e83:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
80103e8a:	e8 d1 07 00 00       	call   80104660 <release>
    acquire(lk);
...
80103e9b:	5d                   	pop    %ebp
    acquire(lk);
80103e9c:	e9 ff 06 00 00       	jmp    801045a0 <acquire>
...
80103ec9:	68 cf 7a 10 80       	push   $0x80107acf
80103ece:	e8 bd c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103ed3:	83 ec 0c             	sub    $0xc,%esp
80103ed6:	68 c9 7a 10 80       	push   $0x80107ac9
...
80103ee4:	53                   	push   %ebx
  pushcli();
80103ee5:	e8 e6 05 00 00       	call   801044d0 <pushcli>
  c = mycpu();
...
80103f2f:	74 37                	je     80103f68 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f31:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
      havekids = 1;
80103f37:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f3c:	81 fb 14 7a 11 80    	cmp    $0x80117a14,%ebx
...
80103f52:	68 e0 36 11 80       	push   $0x801136e0
...
80103f7a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f81:	e8 5a 30 00 00       	call   80106fe0 <freevm>
        release(&ptable.lock);
80103f86:	c7 04 24 e0 36 11 80 	movl   $0x801136e0,(%esp)
        p->pid = 0;
...
80103fa6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fad:	e8 ae 06 00 00       	call   80104660 <release>
        return pid;
...
80103fc1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fc6:	68 e0 36 11 80       	push   $0x801136e0
80103fcb:	e8 90 06 00 00       	call   80104660 <release>
      return -1;
...
80103fe7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103fea:	68 e0 36 11 80       	push   $0x801136e0
80103fef:	e8 ac 05 00 00       	call   801045a0 <acquire>
80103ff4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ff7:	b8 14 37 11 80       	mov    $0x80113714,%eax
80103ffc:	eb 0e                	jmp    8010400c <wakeup+0x2c>
80103ffe:	66 90                	xchg   %ax,%ax
80104000:	05 0c 01 00 00       	add    $0x10c,%eax
80104005:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
...
80104017:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010401e:	05 0c 01 00 00       	add    $0x10c,%eax
80104023:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
80104028:	72 e2                	jb     8010400c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010402a:	c7 45 08 e0 36 11 80 	movl   $0x801136e0,0x8(%ebp)
}
80104031:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104034:	c9                   	leave  
  release(&ptable.lock);
80104035:	e9 26 06 00 00       	jmp    80104660 <release>
...
80104047:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010404a:	68 e0 36 11 80       	push   $0x801136e0
8010404f:	e8 4c 05 00 00       	call   801045a0 <acquire>
80104054:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104057:	b8 14 37 11 80       	mov    $0x80113714,%eax
8010405c:	eb 0e                	jmp    8010406c <kill+0x2c>
8010405e:	66 90                	xchg   %ax,%ax
80104060:	05 0c 01 00 00       	add    $0x10c,%eax
80104065:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
...
80104088:	68 e0 36 11 80       	push   $0x801136e0
8010408d:	e8 ce 05 00 00       	call   80104660 <release>
      return 0;
...
801040a3:	68 e0 36 11 80       	push   $0x801136e0
801040a8:	e8 b3 05 00 00       	call   80104660 <release>
  return -1;
...
801040c6:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040c9:	bb 14 37 11 80       	mov    $0x80113714,%ebx
{
...
801040db:	68 6b 7e 10 80       	push   $0x80107e6b
801040e0:	e8 7b c5 ff ff       	call   80100660 <cprintf>
801040e5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040e8:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
801040ee:	81 fb 14 7a 11 80    	cmp    $0x80117a14,%ebx
...
80104101:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104104:	ba e0 7a 10 80       	mov    $0x80107ae0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104109:	77 11                	ja     8010411c <procdump+0x5c>
8010410b:	8b 14 85 40 7b 10 80 	mov    -0x7fef84c0(,%eax,4),%edx
      state = "???";
80104112:	b8 e0 7a 10 80       	mov    $0x80107ae0,%eax
...
80104124:	68 e4 7a 10 80       	push   $0x80107ae4
...
8010414b:	e8 30 03 00 00       	call   80104480 <getcallerpcs>
...
80104169:	68 21 75 10 80       	push   $0x80107521
...
80104195:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104198:	bb 14 37 11 80       	mov    $0x80113714,%ebx
  acquire(&ptable.lock);
8010419d:	83 ec 0c             	sub    $0xc,%esp
801041a0:	68 e0 36 11 80       	push   $0x801136e0
801041a5:	e8 f6 03 00 00       	call   801045a0 <acquire>
801041aa:	83 c4 10             	add    $0x10,%esp
801041ad:	eb 0f                	jmp    801041be <getpriority+0x2e>
801041af:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041b0:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
801041b6:	81 fb 14 7a 11 80    	cmp    $0x80117a14,%ebx
801041bc:	73 22                	jae    801041e0 <getpriority+0x50>
    if(p->pid == pid){
801041be:	39 73 10             	cmp    %esi,0x10(%ebx)
801041c1:	75 ed                	jne    801041b0 <getpriority+0x20>
      release(&ptable.lock);
801041c3:	83 ec 0c             	sub    $0xc,%esp
801041c6:	68 e0 36 11 80       	push   $0x801136e0
801041cb:	e8 90 04 00 00       	call   80104660 <release>
      return p->priority;
801041d0:	8b 43 7c             	mov    0x7c(%ebx),%eax
...
801041e3:	68 e0 36 11 80       	push   $0x801136e0
801041e8:	e8 73 04 00 00       	call   80104660 <release>
  return -1;
...
80104207:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  int oldpriority = -1;
  acquire(&ptable.lock);
8010420a:	68 e0 36 11 80       	push   $0x801136e0
8010420f:	e8 8c 03 00 00       	call   801045a0 <acquire>
80104214:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104217:	ba 14 37 11 80       	mov    $0x80113714,%edx
8010421c:	eb 10                	jmp    8010422e <setpriority+0x2e>
8010421e:	66 90                	xchg   %ax,%ax
80104220:	81 c2 0c 01 00 00    	add    $0x10c,%edx
80104226:	81 fa 14 7a 11 80    	cmp    $0x80117a14,%edx
8010422c:	73 22                	jae    80104250 <setpriority+0x50>
    if(p->pid == pid){
8010422e:	39 5a 10             	cmp    %ebx,0x10(%edx)
80104231:	75 ed                	jne    80104220 <setpriority+0x20>
      oldpriority = p->priority;
      p->priority = priority;
80104233:	8b 45 0c             	mov    0xc(%ebp),%eax
      oldpriority = p->priority;
80104236:	8b 5a 7c             	mov    0x7c(%edx),%ebx
      p->priority = priority;
80104239:	89 42 7c             	mov    %eax,0x7c(%edx)
      break;
    }
  }
  release(&ptable.lock);
8010423c:	83 ec 0c             	sub    $0xc,%esp
8010423f:	68 e0 36 11 80       	push   $0x801136e0
80104244:	e8 17 04 00 00       	call   80104660 <release>
  return oldpriority;
}
...
8010424f:	c3                   	ret    
  int oldpriority = -1;
80104250:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104255:	eb e5                	jmp    8010423c <setpriority+0x3c>
...
80104267:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  int usage = -1;
  acquire(&ptable.lock);
8010426a:	68 e0 36 11 80       	push   $0x801136e0
8010426f:	e8 2c 03 00 00       	call   801045a0 <acquire>
80104274:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104277:	b8 14 37 11 80       	mov    $0x80113714,%eax
8010427c:	eb 0e                	jmp    8010428c <getusage+0x2c>
8010427e:	66 90                	xchg   %ax,%ax
80104280:	05 0c 01 00 00       	add    $0x10c,%eax
80104285:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
8010428a:	73 24                	jae    801042b0 <getusage+0x50>
    if(p->pid == pid){
8010428c:	39 58 10             	cmp    %ebx,0x10(%eax)
8010428f:	75 ef                	jne    80104280 <getusage+0x20>
      usage = p->usage;
80104291:	8b 98 80 00 00 00    	mov    0x80(%eax),%ebx
      break;
    }
  }
  release(&ptable.lock);
80104297:	83 ec 0c             	sub    $0xc,%esp
8010429a:	68 e0 36 11 80       	push   $0x801136e0
8010429f:	e8 bc 03 00 00       	call   80104660 <release>
  return usage;
}
...
801042ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  int usage = -1;
801042b0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801042b5:	eb e0                	jmp    80104297 <getusage+0x37>
...
801042c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  int result = -1;
  acquire(&ptable.lock);
801042ca:	68 e0 36 11 80       	push   $0x801136e0
801042cf:	e8 cc 02 00 00       	call   801045a0 <acquire>
801042d4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042d7:	b8 14 37 11 80       	mov    $0x80113714,%eax
801042dc:	eb 0e                	jmp    801042ec <trace+0x2c>
801042de:	66 90                	xchg   %ax,%ax
801042e0:	05 0c 01 00 00       	add    $0x10c,%eax
801042e5:	3d 14 7a 11 80       	cmp    $0x80117a14,%eax
801042ea:	73 24                	jae    80104310 <trace+0x50>
    if(p->pid == pid){
801042ec:	39 58 10             	cmp    %ebx,0x10(%eax)
801042ef:	75 ef                	jne    801042e0 <trace+0x20>
      result = p->mapcalls[syscall_id];
801042f1:	8b 55 0c             	mov    0xc(%ebp),%edx
801042f4:	8b 9c 90 84 00 00 00 	mov    0x84(%eax,%edx,4),%ebx
      break;
    }
  }
  release(&ptable.lock);
801042fb:	83 ec 0c             	sub    $0xc,%esp
801042fe:	68 e0 36 11 80       	push   $0x801136e0
80104303:	e8 58 03 00 00       	call   80104660 <release>
  return result;
}
...
8010430f:	90                   	nop
  int result = -1;
80104310:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104315:	eb e4                	jmp    801042fb <trace+0x3b>
80104317:	89 f6                	mov    %esi,%esi
80104319:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80104320 <getptable_proc>:
//   }
//   release(&ptable.lock);
//   return result;
// }
...
80104320:	55                   	push   %ebp
  return ptable.proc;
80104321:	b8 14 37 11 80       	mov    $0x80113714,%eax
struct proc *getptable_proc(void) {
...
8010433a:	68 58 7b 10 80       	push   $0x80107b58
...
80104395:	e8 86 fa ff ff       	call   80103e20 <sleep>
  while (lk->locked) {
...
801043f4:	e8 e7 fb ff ff       	call   80103fe0 <wakeup>
  release(&lk->lk);
...
80104555:	68 63 7b 10 80       	push   $0x80107b63
8010455a:	e8 31 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 7a 7b 10 80       	push   $0x80107b7a
...
80104647:	68 81 7b 10 80       	push   $0x80107b81
...
8010469c:	68 89 7b 10 80       	push   $0x80107b89
...
801049c3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049c6:	e8 55 ee ff ff       	call   80103820 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104aa4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104aa7:	e8 74 ed ff ff       	call   80103820 <myproc>
...
80104abc:	8b 14 85 c0 7b 10 80 	mov    -0x7fef8440(,%eax,4),%edx
80104ac3:	85 d2                	test   %edx,%edx
80104ac5:	74 19                	je     80104ae0 <syscall+0x40>
    curproc->mapcalls[num]++;
80104ac7:	83 84 83 84 00 00 00 	addl   $0x1,0x84(%ebx,%eax,4)
80104ace:	01 
    curproc->tf->eax = syscalls[num]();
80104acf:	ff d2                	call   *%edx
80104ad1:	8b 53 18             	mov    0x18(%ebx),%edx
80104ad4:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80104ae8:	68 91 7b 10 80       	push   $0x80107b91
...
80104b27:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104b2a:	e8 e1 d3 ff ff       	call   80101f10 <nameiparent>
...
80104b40:	e8 4b cb ff ff       	call   80101690 <ilock>
...
80104b4e:	e8 6d d0 ff ff       	call   80101bc0 <dirlookup>
80104b53:	83 c4 10             	add    $0x10,%esp
80104b56:	85 c0                	test   %eax,%eax
80104b58:	89 c7                	mov    %eax,%edi
80104b5a:	74 34                	je     80104b90 <create+0x80>
    iunlockput(dp);
80104b5c:	83 ec 0c             	sub    $0xc,%esp
80104b5f:	53                   	push   %ebx
80104b60:	e8 bb cd ff ff       	call   80101920 <iunlockput>
    ilock(ip);
80104b65:	89 3c 24             	mov    %edi,(%esp)
80104b68:	e8 23 cb ff ff       	call   80101690 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104b6d:	83 c4 10             	add    $0x10,%esp
80104b70:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104b75:	0f 85 95 00 00 00    	jne    80104c10 <create+0x100>
80104b7b:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104b80:	0f 85 8a 00 00 00    	jne    80104c10 <create+0x100>
...
80104b9a:	e8 81 c9 ff ff       	call   80101520 <ialloc>
...
80104bd1:	e8 0a ca ff ff       	call   801015e0 <iupdate>
...
80104be8:	e8 43 d2 ff ff       	call   80101e30 <dirlink>
...
80104bfc:	e8 1f cd ff ff       	call   80101920 <iunlockput>
  return ip;
...
80104c14:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104c16:	e8 05 cd ff ff       	call   80101920 <iunlockput>
    return 0;
...
80104c39:	e8 a2 c9 ff ff       	call   801015e0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c3e:	83 c4 0c             	add    $0xc,%esp
80104c41:	ff 77 04             	pushl  0x4(%edi)
80104c44:	68 48 7c 10 80       	push   $0x80107c48
...
80104c5c:	68 47 7c 10 80       	push   $0x80107c47
80104c61:	57                   	push   %edi
80104c62:	e8 c9 d1 ff ff       	call   80101e30 <dirlink>
...
80104cd4:	e8 47 eb ff ff       	call   80103820 <myproc>
...
80104d19:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d1b:	e8 00 eb ff ff       	call   80103820 <myproc>
...
80104f22:	0f 88 e2 00 00 00    	js     8010500a <sys_link+0x11a>
  begin_op();
80104f28:	e8 83 dc ff ff       	call   80102bb0 <begin_op>
  if((ip = namei(old)) == 0){
80104f2d:	83 ec 0c             	sub    $0xc,%esp
80104f30:	ff 75 d4             	pushl  -0x2c(%ebp)
80104f33:	e8 b8 cf ff ff       	call   80101ef0 <namei>
...
80104f68:	e8 73 c6 ff ff       	call   801015e0 <iupdate>
  iunlock(ip);
80104f6d:	89 1c 24             	mov    %ebx,(%esp)
80104f70:	e8 fb c7 ff ff       	call   80101770 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104f75:	58                   	pop    %eax
80104f76:	5a                   	pop    %edx
80104f77:	57                   	push   %edi
80104f78:	ff 75 d0             	pushl  -0x30(%ebp)
80104f7b:	e8 90 cf ff ff       	call   80101f10 <nameiparent>
...
80104f8d:	e8 fe c6 ff ff       	call   80101690 <ilock>
...
80104fa3:	e8 88 ce ff ff       	call   80101e30 <dirlink>
...
80104fb3:	e8 68 c9 ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104fb8:	89 1c 24             	mov    %ebx,(%esp)
80104fbb:	e8 00 c8 ff ff       	call   801017c0 <iput>
  end_op();
...
8010502d:	eb 9b                	jmp    80104fca <sys_link+0xda>
    end_op();
8010502f:	e8 ec db ff ff       	call   80102c20 <end_op>
    return -1;
...
8010504f:	e8 0c fa ff ff       	call   80104a60 <argstr>
...
80105089:	58                   	pop    %eax
8010508a:	5a                   	pop    %edx
8010508b:	68 48 7c 10 80       	push   $0x80107c48
...
801050a4:	68 47 7c 10 80       	push   $0x80107c47
...
801050fe:	e8 ad f5 ff ff       	call   801046b0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010510d:	e8 5e c9 ff ff       	call   80101a70 <writei>
...
8010512d:	e8 ee c7 ff ff       	call   80101920 <iunlockput>
  ip->nlink--;
80105132:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105137:	89 1c 24             	mov    %ebx,(%esp)
8010513a:	e8 a1 c4 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
8010513f:	89 1c 24             	mov    %ebx,(%esp)
80105142:	e8 d9 c7 ff ff       	call   80101920 <iunlockput>
  end_op();
80105147:	e8 d4 da ff ff       	call   80102c20 <end_op>
  return 0;
...
80105184:	e8 e7 c7 ff ff       	call   80101970 <readi>
...
801051a8:	e8 73 c7 ff ff       	call   80101920 <iunlockput>
  end_op();
801051ad:	e8 6e da ff ff       	call   80102c20 <end_op>
  return -1;
...
801051c9:	e8 12 c4 ff ff       	call   801015e0 <iupdate>
...
8010522f:	e8 2c f8 ff ff       	call   80104a60 <argstr>
...
80105248:	e8 63 f7 ff ff       	call   801049b0 <argint>
...
80105252:	0f 88 04 01 00 00    	js     8010535c <sys_open+0x13c>
  ...
  begin_op();
80105258:	e8 53 d9 ff ff       	call   80102bb0 <begin_op>
...
8010526d:	e8 7e cc ff ff       	call   80101ef0 <namei>
...
80105283:	e8 08 c4 ff ff       	call   80101690 <ilock>
...
8010529f:	0f 84 a6 00 00 00    	je     8010534b <sys_open+0x12b>
  struct proc *curproc = myproc();
801052a5:	e8 76 e5 ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801052cc:	e8 9f c4 ff ff       	call   80101770 <iunlock>
  end_op();
...
8010534f:	e8 cc c5 ff ff       	call   80101920 <iunlockput>
    end_op();
...
80105394:	e8 c7 f6 ff ff       	call   80104a60 <argstr>
...
801053f4:	e8 67 f6 ff ff       	call   80104a60 <argstr>
...
8010544e:	e8 cd c4 ff ff       	call   80101920 <iunlockput>
  end_op();
80105453:	e8 c8 d7 ff ff       	call   80102c20 <end_op>
  return 0;
...
8010549f:	e8 4c ca ff ff       	call   80101ef0 <namei>
...
801054b1:	e8 da c1 ff ff       	call   80101690 <ilock>
  if(ip->type != T_DIR){
...
801054c4:	e8 a7 c2 ff ff       	call   80101770 <iunlock>
  iput(curproc->cwd);
801054c9:	58                   	pop    %eax
801054ca:	ff 76 68             	pushl  0x68(%esi)
801054cd:	e8 ee c2 ff ff       	call   801017c0 <iput>
  end_op();
801054d2:	e8 49 d7 ff ff       	call   80102c20 <end_op>
  curproc->cwd = ip;
...
801054f4:	e8 27 c4 ff ff       	call   80101920 <iunlockput>
    end_op();
801054f9:	e8 22 d7 ff ff       	call   80102c20 <end_op>
    return -1;
...
80105535:	e8 26 f5 ff ff       	call   80104a60 <argstr>
...
80105576:	e8 35 f1 ff ff       	call   801046b0 <memset>
...
80105598:	e8 a3 f3 ff ff       	call   80104940 <fetchstr>
...
801055c0:	e8 3b f3 ff ff       	call   80104900 <fetchint>
...
8010563c:	e8 0f dc ff ff       	call   80103250 <pipealloc>
...
80105677:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010567a:	e8 a1 e1 ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801056b8:	e8 63 e1 ff ff       	call   80103820 <myproc>
...
801056f3:	5d                   	pop    %ebp
  return fork();
801056f4:	e9 c7 e2 ff ff       	jmp    801039c0 <fork>
...
80105703:	83 ec 08             	sub    $0x8,%esp
  exit();
80105706:	e8 95 e5 ff ff       	call   80103ca0 <exit>
...
80105713:	5d                   	pop    %ebp
  return wait();
80105714:	e9 c7 e7 ff ff       	jmp    80103ee0 <wait>
...
8010573e:	e8 fd e8 ff ff       	call   80104040 <kill>
...
80105763:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105766:	e8 b5 e0 ff ff       	call   80103820 <myproc>
...
80105787:	78 27                	js     801057b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105789:	e8 92 e0 ff ff       	call   80103820 <myproc>
  if(growproc(n) < 0)
...
80105796:	e8 a5 e1 ff ff       	call   80103940 <growproc>
...
801057e0:	68 20 7a 11 80       	push   $0x80117a20
801057e5:	e8 b6 ed ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ea:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057ed:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801057f0:	8b 1d 60 82 11 80    	mov    0x80118260,%ebx
  while(ticks - ticks0 < n){
...
80105803:	68 20 7a 11 80       	push   $0x80117a20
80105808:	68 60 82 11 80       	push   $0x80118260
8010580d:	e8 0e e6 ff ff       	call   80103e20 <sleep>
  while(ticks - ticks0 < n){
80105812:	a1 60 82 11 80       	mov    0x80118260,%eax
...
8010581f:	73 2f                	jae    80105850 <sys_sleep+0x90>
    if(myproc()->killed){
80105821:	e8 fa df ff ff       	call   80103820 <myproc>
...
80105830:	68 20 7a 11 80       	push   $0x80117a20
80105835:	e8 26 ee ff ff       	call   80104660 <release>
      return -1;
...
80105853:	68 20 7a 11 80       	push   $0x80117a20
...
80105874:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105877:	68 20 7a 11 80       	push   $0x80117a20
8010587c:	e8 1f ed ff ff       	call   801045a0 <acquire>
  xticks = ticks;
80105881:	8b 1d 60 82 11 80    	mov    0x80118260,%ebx
  release(&tickslock);
80105887:	c7 04 24 20 7a 11 80 	movl   $0x80117a20,(%esp)
...
801058ac:	e8 ff f0 ff ff       	call   801049b0 <argint>
801058b1:	83 c4 10             	add    $0x10,%esp
801058b4:	85 c0                	test   %eax,%eax
801058b6:	78 18                	js     801058d0 <sys_getpriority+0x30>
    return -1;
  return getpriority(pid);
801058b8:	83 ec 0c             	sub    $0xc,%esp
801058bb:	ff 75 f4             	pushl  -0xc(%ebp)
801058be:	e8 cd e8 ff ff       	call   80104190 <getpriority>
...
801058f6:	78 28                	js     80105920 <sys_setpriority+0x40>
    return -1;
...
80105901:	e8 aa f0 ff ff       	call   801049b0 <argint>
80105906:	83 c4 10             	add    $0x10,%esp
80105909:	85 c0                	test   %eax,%eax
8010590b:	78 13                	js     80105920 <sys_setpriority+0x40>
    return -1;
...
80105916:	e8 e5 e8 ff ff       	call   80104200 <setpriority>
...
8010593c:	e8 6f f0 ff ff       	call   801049b0 <argint>
80105941:	83 c4 10             	add    $0x10,%esp
80105944:	85 c0                	test   %eax,%eax
80105946:	78 18                	js     80105960 <sys_getusage+0x30>
    return -1;

  return getusage(pid);
80105948:	83 ec 0c             	sub    $0xc,%esp
8010594b:	ff 75 f4             	pushl  -0xc(%ebp)
8010594e:	e8 0d e9 ff ff       	call   80104260 <getusage>
...
8010597c:	e8 2f f0 ff ff       	call   801049b0 <argint>
80105981:	83 c4 10             	add    $0x10,%esp
80105984:	85 c0                	test   %eax,%eax
80105986:	78 28                	js     801059b0 <sys_trace+0x40>
    return -1;
...
80105991:	e8 1a f0 ff ff       	call   801049b0 <argint>
80105996:	83 c4 10             	add    $0x10,%esp
80105999:	85 c0                	test   %eax,%eax
8010599b:	78 13                	js     801059b0 <sys_trace+0x40>
    return -1;
...
801059a6:	e8 15 e9 ff ff       	call   801042c0 <trace>
...
801059ce:	e8 dd ef ff ff       	call   801049b0 <argint>
801059d3:	83 c4 10             	add    $0x10,%esp
801059d6:	85 c0                	test   %eax,%eax
801059d8:	0f 88 8f 00 00 00    	js     80105a6d <sys_getptable+0xad>
    return -1;
  }
...
801059ea:	e8 11 f0 ff ff       	call   80104a00 <argptr>
801059ef:	83 c4 10             	add    $0x10,%esp
801059f2:	85 c0                	test   %eax,%eax
801059f4:	78 77                	js     80105a6d <sys_getptable+0xad>
    return -1;
  }

  s = buf;
801059f6:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  p = getptable_proc();
801059f9:	e8 22 e9 ff ff       	call   80104320 <getptable_proc>

  while(buf + size > s && p->state != UNUSED){
801059fe:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a01:	03 55 f4             	add    -0xc(%ebp),%edx
80105a04:	39 d3                	cmp    %edx,%ebx
80105a06:	73 5c                	jae    80105a64 <sys_getptable+0xa4>
80105a08:	8b 50 0c             	mov    0xc(%eax),%edx
80105a0b:	85 d2                	test   %edx,%edx
80105a0d:	74 55                	je     80105a64 <sys_getptable+0xa4>
80105a0f:	8d 70 6c             	lea    0x6c(%eax),%esi
80105a12:	eb 11                	jmp    80105a25 <sys_getptable+0x65>
80105a14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105a18:	81 c6 0c 01 00 00    	add    $0x10c,%esi
80105a1e:	8b 56 a0             	mov    -0x60(%esi),%edx
80105a21:	85 d2                	test   %edx,%edx
80105a23:	74 3f                	je     80105a64 <sys_getptable+0xa4>
    *(int *)s = p->state;
80105a25:	89 13                	mov    %edx,(%ebx)
    s+=4;
    *(int *)s = p->pid;
80105a27:	8b 46 a4             	mov    -0x5c(%esi),%eax
    s+=4;
...
80105a2a:	83 ec 04             	sub    $0x4,%esp
    *(int *)s = p->pid;
80105a2d:	89 43 04             	mov    %eax,0x4(%ebx)
    *(int *)s = p->parent->pid;
80105a30:	8b 46 a8             	mov    -0x58(%esi),%eax
80105a33:	8b 40 10             	mov    0x10(%eax),%eax
80105a36:	89 43 08             	mov    %eax,0x8(%ebx)
    *(int *)s = p->schedulepriority;
80105a39:	8b 86 98 00 00 00    	mov    0x98(%esi),%eax
80105a3f:	89 43 0c             	mov    %eax,0xc(%ebx)
    *(int *)s = p->usage;
80105a42:	8b 46 14             	mov    0x14(%esi),%eax
80105a45:	89 43 10             	mov    %eax,0x10(%ebx)
    memmove(s,p->name,16);
80105a48:	8d 43 14             	lea    0x14(%ebx),%eax
80105a4b:	6a 10                	push   $0x10
80105a4d:	56                   	push   %esi
80105a4e:	83 c3 24             	add    $0x24,%ebx
80105a51:	50                   	push   %eax
80105a52:	e8 09 ed ff ff       	call   80104760 <memmove>
  while(buf + size > s && p->state != UNUSED){
80105a57:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a5a:	03 45 f4             	add    -0xc(%ebp),%eax
80105a5d:	83 c4 10             	add    $0x10,%esp
80105a60:	39 c3                	cmp    %eax,%ebx
80105a62:	72 b4                	jb     80105a18 <sys_getptable+0x58>
    s+=16;
    p++;
  }
  return 0;
80105a64:	31 c0                	xor    %eax,%eax
...
80105a72:	eb f2                	jmp    80105a66 <sys_getptable+0xa6>
...
80105a75:	06                   	push   %es
  pushl %fs
80105a76:	0f a0                	push   %fs
  pushl %gs
80105a78:	0f a8                	push   %gs
  pushal
80105a7a:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a7b:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a7f:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a81:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a83:	54                   	push   %esp
  call trap
80105a84:	e8 c7 00 00 00       	call   80105b50 <trap>
  addl $4, %esp
80105a89:	83 c4 04             	add    $0x4,%esp
...
80105a8c:	61                   	popa   
  popl %gs
80105a8d:	0f a9                	pop    %gs
  popl %fs
80105a8f:	0f a1                	pop    %fs
  popl %es
80105a91:	07                   	pop    %es
  popl %ds
80105a92:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a93:	83 c4 08             	add    $0x8,%esp
  iret
80105a96:	cf                   	iret   
...
80105ab7:	c7 04 c5 62 7a 11 80 	movl   $0x8e000008,-0x7fee859e(,%eax,8)
80105abe:	08 00 00 8e 
80105ac2:	66 89 14 c5 60 7a 11 	mov    %dx,-0x7fee85a0(,%eax,8)
80105ac9:	80 
80105aca:	c1 ea 10             	shr    $0x10,%edx
80105acd:	66 89 14 c5 66 7a 11 	mov    %dx,-0x7fee859a(,%eax,8)
80105ad4:	80 
  for(i = 0; i < 256; i++)
...
80105ae4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ae7:	c7 05 62 7c 11 80 08 	movl   $0xef000008,0x80117c62
80105aee:	00 00 ef 
  initlock(&tickslock, "time");
80105af1:	68 8d 7c 10 80       	push   $0x80107c8d
80105af6:	68 20 7a 11 80       	push   $0x80117a20
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105afb:	66 a3 60 7c 11 80    	mov    %ax,0x80117c60
80105b01:	c1 e8 10             	shr    $0x10,%eax
80105b04:	66 a3 66 7c 11 80    	mov    %ax,0x80117c66
  initlock(&tickslock, "time");
80105b0a:	e8 51 e9 ff ff       	call   80104460 <initlock>
}
...
80105b2b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b2f:	b8 60 7a 11 80       	mov    $0x80117a60,%eax
...
80105b70:	ff 24 85 34 7d 10 80 	jmp    *-0x7fef82cc(,%eax,4)
...
80105b80:	e8 9b dc ff ff       	call   80103820 <myproc>
...
80105ba0:	e8 5b dc ff ff       	call   80103800 <cpuid>
...
80105bb1:	e8 6a dc ff ff       	call   80103820 <myproc>
...
80105bd5:	68 f0 7c 10 80       	push   $0x80107cf0
80105bda:	e8 81 aa ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105bdf:	83 c4 20             	add    $0x20,%esp
80105be2:	e8 39 dc ff ff       	call   80103820 <myproc>
...
80105bee:	e8 2d dc ff ff       	call   80103820 <myproc>
80105bf3:	85 c0                	test   %eax,%eax
80105bf5:	74 1d                	je     80105c14 <trap+0xc4>
80105bf7:	e8 24 dc ff ff       	call   80103820 <myproc>
...
80105c14:	e8 07 dc ff ff       	call   80103820 <myproc>
80105c19:	85 c0                	test   %eax,%eax
80105c1b:	74 0b                	je     80105c28 <trap+0xd8>
80105c1d:	e8 fe db ff ff       	call   80103820 <myproc>
...
80105c26:	74 68                	je     80105c90 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c28:	e8 f3 db ff ff       	call   80103820 <myproc>
80105c2d:	85 c0                	test   %eax,%eax
80105c2f:	74 19                	je     80105c4a <trap+0xfa>
80105c31:	e8 ea db ff ff       	call   80103820 <myproc>
...
80105c52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105c58:	e8 c3 db ff ff       	call   80103820 <myproc>
80105c5d:	8b 58 24             	mov    0x24(%eax),%ebx
80105c60:	85 db                	test   %ebx,%ebx
80105c62:	0f 85 e8 00 00 00    	jne    80105d50 <trap+0x200>
    myproc()->tf = tf;
80105c68:	e8 b3 db ff ff       	call   80103820 <myproc>
80105c6d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105c70:	e8 2b ee ff ff       	call   80104aa0 <syscall>
    if(myproc()->killed)
80105c75:	e8 a6 db ff ff       	call   80103820 <myproc>
...
80105ccd:	e8 8e ca ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cd2:	e8 49 db ff ff       	call   80103820 <myproc>
...
80105d0f:	e8 ec da ff ff       	call   80103800 <cpuid>
80105d14:	56                   	push   %esi
80105d15:	53                   	push   %ebx
80105d16:	50                   	push   %eax
80105d17:	68 98 7c 10 80       	push   $0x80107c98
...
80105d26:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d29:	e8 f2 da ff ff       	call   80103820 <myproc>
...
80105d5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105d60:	e8 3b df ff ff       	call   80103ca0 <exit>
80105d65:	e9 aa fe ff ff       	jmp    80105c14 <trap+0xc4>
80105d6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105d70:	83 ec 0c             	sub    $0xc,%esp
80105d73:	68 20 7a 11 80       	push   $0x80117a20
80105d78:	e8 23 e8 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105d7d:	c7 04 24 60 82 11 80 	movl   $0x80118260,(%esp)
      ticks++;
80105d84:	83 05 60 82 11 80 01 	addl   $0x1,0x80118260
      wakeup(&ticks);
80105d8b:	e8 50 e2 ff ff       	call   80103fe0 <wakeup>
      release(&tickslock);
80105d90:	c7 04 24 20 7a 11 80 	movl   $0x80117a20,(%esp)
80105d97:	e8 c4 e8 ff ff       	call   80104660 <release>
80105d9c:	83 c4 10             	add    $0x10,%esp
80105d9f:	e9 09 ff ff ff       	jmp    80105cad <trap+0x15d>
80105da4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105da7:	e8 54 da ff ff       	call   80103800 <cpuid>
...
80105db5:	68 bc 7c 10 80       	push   $0x80107cbc
80105dba:	e8 a1 a8 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105dbf:	83 c4 14             	add    $0x14,%esp
80105dc2:	68 92 7c 10 80       	push   $0x80107c92
...
80105ebc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ebf:	bb b4 7d 10 80       	mov    $0x80107db4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105f57:	6a 00                	push   $0x0
  jmp alltraps
80105f59:	e9 16 fb ff ff       	jmp    80105a74 <alltraps>
...
80105f60:	6a 01                	push   $0x1
  jmp alltraps
80105f62:	e9 0d fb ff ff       	jmp    80105a74 <alltraps>
...
80105f69:	6a 02                	push   $0x2
  jmp alltraps
80105f6b:	e9 04 fb ff ff       	jmp    80105a74 <alltraps>
...
80105f72:	6a 03                	push   $0x3
  jmp alltraps
80105f74:	e9 fb fa ff ff       	jmp    80105a74 <alltraps>
...
80105f7b:	6a 04                	push   $0x4
  jmp alltraps
80105f7d:	e9 f2 fa ff ff       	jmp    80105a74 <alltraps>
...
80105f84:	6a 05                	push   $0x5
  jmp alltraps
80105f86:	e9 e9 fa ff ff       	jmp    80105a74 <alltraps>
...
80105f8d:	6a 06                	push   $0x6
  jmp alltraps
80105f8f:	e9 e0 fa ff ff       	jmp    80105a74 <alltraps>
...
80105f96:	6a 07                	push   $0x7
  jmp alltraps
80105f98:	e9 d7 fa ff ff       	jmp    80105a74 <alltraps>
...
80105f9d:	6a 08                	push   $0x8
  jmp alltraps
80105f9f:	e9 d0 fa ff ff       	jmp    80105a74 <alltraps>
...
80105fa6:	6a 09                	push   $0x9
  jmp alltraps
80105fa8:	e9 c7 fa ff ff       	jmp    80105a74 <alltraps>
...
80105fad:	6a 0a                	push   $0xa
  jmp alltraps
80105faf:	e9 c0 fa ff ff       	jmp    80105a74 <alltraps>
...
80105fb4:	6a 0b                	push   $0xb
  jmp alltraps
80105fb6:	e9 b9 fa ff ff       	jmp    80105a74 <alltraps>
...
80105fbb:	6a 0c                	push   $0xc
  jmp alltraps
80105fbd:	e9 b2 fa ff ff       	jmp    80105a74 <alltraps>
...
80105fc2:	6a 0d                	push   $0xd
  jmp alltraps
80105fc4:	e9 ab fa ff ff       	jmp    80105a74 <alltraps>
...
80105fc9:	6a 0e                	push   $0xe
  jmp alltraps
80105fcb:	e9 a4 fa ff ff       	jmp    80105a74 <alltraps>
...
80105fd2:	6a 0f                	push   $0xf
  jmp alltraps
80105fd4:	e9 9b fa ff ff       	jmp    80105a74 <alltraps>
...
80105fdb:	6a 10                	push   $0x10
  jmp alltraps
80105fdd:	e9 92 fa ff ff       	jmp    80105a74 <alltraps>
...
80105fe2:	6a 11                	push   $0x11
  jmp alltraps
80105fe4:	e9 8b fa ff ff       	jmp    80105a74 <alltraps>
...
80105feb:	6a 12                	push   $0x12
  jmp alltraps
80105fed:	e9 82 fa ff ff       	jmp    80105a74 <alltraps>
...
80105ff4:	6a 13                	push   $0x13
  jmp alltraps
80105ff6:	e9 79 fa ff ff       	jmp    80105a74 <alltraps>
...
80105ffd:	6a 14                	push   $0x14
  jmp alltraps
80105fff:	e9 70 fa ff ff       	jmp    80105a74 <alltraps>
...
80106006:	6a 15                	push   $0x15
  jmp alltraps
80106008:	e9 67 fa ff ff       	jmp    80105a74 <alltraps>
...
8010600f:	6a 16                	push   $0x16
  jmp alltraps
80106011:	e9 5e fa ff ff       	jmp    80105a74 <alltraps>
...
80106018:	6a 17                	push   $0x17
  jmp alltraps
8010601a:	e9 55 fa ff ff       	jmp    80105a74 <alltraps>
...
80106021:	6a 18                	push   $0x18
  jmp alltraps
80106023:	e9 4c fa ff ff       	jmp    80105a74 <alltraps>
...
8010602a:	6a 19                	push   $0x19
  jmp alltraps
8010602c:	e9 43 fa ff ff       	jmp    80105a74 <alltraps>
...
80106033:	6a 1a                	push   $0x1a
  jmp alltraps
80106035:	e9 3a fa ff ff       	jmp    80105a74 <alltraps>
...
8010603c:	6a 1b                	push   $0x1b
  jmp alltraps
8010603e:	e9 31 fa ff ff       	jmp    80105a74 <alltraps>
...
80106045:	6a 1c                	push   $0x1c
  jmp alltraps
80106047:	e9 28 fa ff ff       	jmp    80105a74 <alltraps>
...
8010604e:	6a 1d                	push   $0x1d
  jmp alltraps
80106050:	e9 1f fa ff ff       	jmp    80105a74 <alltraps>
...
80106057:	6a 1e                	push   $0x1e
  jmp alltraps
80106059:	e9 16 fa ff ff       	jmp    80105a74 <alltraps>
...
80106060:	6a 1f                	push   $0x1f
  jmp alltraps
80106062:	e9 0d fa ff ff       	jmp    80105a74 <alltraps>
...
80106069:	6a 20                	push   $0x20
  jmp alltraps
8010606b:	e9 04 fa ff ff       	jmp    80105a74 <alltraps>
...
80106072:	6a 21                	push   $0x21
  jmp alltraps
80106074:	e9 fb f9 ff ff       	jmp    80105a74 <alltraps>
...
8010607b:	6a 22                	push   $0x22
  jmp alltraps
8010607d:	e9 f2 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106084:	6a 23                	push   $0x23
  jmp alltraps
80106086:	e9 e9 f9 ff ff       	jmp    80105a74 <alltraps>
...
8010608d:	6a 24                	push   $0x24
  jmp alltraps
8010608f:	e9 e0 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106096:	6a 25                	push   $0x25
  jmp alltraps
80106098:	e9 d7 f9 ff ff       	jmp    80105a74 <alltraps>
...
8010609f:	6a 26                	push   $0x26
  jmp alltraps
801060a1:	e9 ce f9 ff ff       	jmp    80105a74 <alltraps>
...
801060a8:	6a 27                	push   $0x27
  jmp alltraps
801060aa:	e9 c5 f9 ff ff       	jmp    80105a74 <alltraps>
...
801060b1:	6a 28                	push   $0x28
  jmp alltraps
801060b3:	e9 bc f9 ff ff       	jmp    80105a74 <alltraps>
...
801060ba:	6a 29                	push   $0x29
  jmp alltraps
801060bc:	e9 b3 f9 ff ff       	jmp    80105a74 <alltraps>
...
801060c3:	6a 2a                	push   $0x2a
  jmp alltraps
801060c5:	e9 aa f9 ff ff       	jmp    80105a74 <alltraps>
...
801060cc:	6a 2b                	push   $0x2b
  jmp alltraps
801060ce:	e9 a1 f9 ff ff       	jmp    80105a74 <alltraps>
...
801060d5:	6a 2c                	push   $0x2c
  jmp alltraps
801060d7:	e9 98 f9 ff ff       	jmp    80105a74 <alltraps>
...
801060de:	6a 2d                	push   $0x2d
  jmp alltraps
801060e0:	e9 8f f9 ff ff       	jmp    80105a74 <alltraps>
...
801060e7:	6a 2e                	push   $0x2e
  jmp alltraps
801060e9:	e9 86 f9 ff ff       	jmp    80105a74 <alltraps>
...
801060f0:	6a 2f                	push   $0x2f
  jmp alltraps
801060f2:	e9 7d f9 ff ff       	jmp    80105a74 <alltraps>
...
801060f9:	6a 30                	push   $0x30
  jmp alltraps
801060fb:	e9 74 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106102:	6a 31                	push   $0x31
  jmp alltraps
80106104:	e9 6b f9 ff ff       	jmp    80105a74 <alltraps>
...
8010610b:	6a 32                	push   $0x32
  jmp alltraps
8010610d:	e9 62 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106114:	6a 33                	push   $0x33
  jmp alltraps
80106116:	e9 59 f9 ff ff       	jmp    80105a74 <alltraps>
...
8010611d:	6a 34                	push   $0x34
  jmp alltraps
8010611f:	e9 50 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106126:	6a 35                	push   $0x35
  jmp alltraps
80106128:	e9 47 f9 ff ff       	jmp    80105a74 <alltraps>
...
8010612f:	6a 36                	push   $0x36
  jmp alltraps
80106131:	e9 3e f9 ff ff       	jmp    80105a74 <alltraps>
...
80106138:	6a 37                	push   $0x37
  jmp alltraps
8010613a:	e9 35 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106141:	6a 38                	push   $0x38
  jmp alltraps
80106143:	e9 2c f9 ff ff       	jmp    80105a74 <alltraps>
...
8010614a:	6a 39                	push   $0x39
  jmp alltraps
8010614c:	e9 23 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106153:	6a 3a                	push   $0x3a
  jmp alltraps
80106155:	e9 1a f9 ff ff       	jmp    80105a74 <alltraps>
...
8010615c:	6a 3b                	push   $0x3b
  jmp alltraps
8010615e:	e9 11 f9 ff ff       	jmp    80105a74 <alltraps>
...
80106165:	6a 3c                	push   $0x3c
  jmp alltraps
80106167:	e9 08 f9 ff ff       	jmp    80105a74 <alltraps>
...
8010616e:	6a 3d                	push   $0x3d
  jmp alltraps
80106170:	e9 ff f8 ff ff       	jmp    80105a74 <alltraps>
...
80106177:	6a 3e                	push   $0x3e
  jmp alltraps
80106179:	e9 f6 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106180:	6a 3f                	push   $0x3f
  jmp alltraps
80106182:	e9 ed f8 ff ff       	jmp    80105a74 <alltraps>
...
80106189:	6a 40                	push   $0x40
  jmp alltraps
8010618b:	e9 e4 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106192:	6a 41                	push   $0x41
  jmp alltraps
80106194:	e9 db f8 ff ff       	jmp    80105a74 <alltraps>
...
8010619b:	6a 42                	push   $0x42
  jmp alltraps
8010619d:	e9 d2 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061a4:	6a 43                	push   $0x43
  jmp alltraps
801061a6:	e9 c9 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061ad:	6a 44                	push   $0x44
  jmp alltraps
801061af:	e9 c0 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061b6:	6a 45                	push   $0x45
  jmp alltraps
801061b8:	e9 b7 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061bf:	6a 46                	push   $0x46
  jmp alltraps
801061c1:	e9 ae f8 ff ff       	jmp    80105a74 <alltraps>
...
801061c8:	6a 47                	push   $0x47
  jmp alltraps
801061ca:	e9 a5 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061d1:	6a 48                	push   $0x48
  jmp alltraps
801061d3:	e9 9c f8 ff ff       	jmp    80105a74 <alltraps>
...
801061da:	6a 49                	push   $0x49
  jmp alltraps
801061dc:	e9 93 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061e3:	6a 4a                	push   $0x4a
  jmp alltraps
801061e5:	e9 8a f8 ff ff       	jmp    80105a74 <alltraps>
...
801061ec:	6a 4b                	push   $0x4b
  jmp alltraps
801061ee:	e9 81 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061f5:	6a 4c                	push   $0x4c
  jmp alltraps
801061f7:	e9 78 f8 ff ff       	jmp    80105a74 <alltraps>
...
801061fe:	6a 4d                	push   $0x4d
  jmp alltraps
80106200:	e9 6f f8 ff ff       	jmp    80105a74 <alltraps>
...
80106207:	6a 4e                	push   $0x4e
  jmp alltraps
80106209:	e9 66 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106210:	6a 4f                	push   $0x4f
  jmp alltraps
80106212:	e9 5d f8 ff ff       	jmp    80105a74 <alltraps>
...
80106219:	6a 50                	push   $0x50
  jmp alltraps
8010621b:	e9 54 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106222:	6a 51                	push   $0x51
  jmp alltraps
80106224:	e9 4b f8 ff ff       	jmp    80105a74 <alltraps>
...
8010622b:	6a 52                	push   $0x52
  jmp alltraps
8010622d:	e9 42 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106234:	6a 53                	push   $0x53
  jmp alltraps
80106236:	e9 39 f8 ff ff       	jmp    80105a74 <alltraps>
...
8010623d:	6a 54                	push   $0x54
  jmp alltraps
8010623f:	e9 30 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106246:	6a 55                	push   $0x55
  jmp alltraps
80106248:	e9 27 f8 ff ff       	jmp    80105a74 <alltraps>
...
8010624f:	6a 56                	push   $0x56
  jmp alltraps
80106251:	e9 1e f8 ff ff       	jmp    80105a74 <alltraps>
...
80106258:	6a 57                	push   $0x57
  jmp alltraps
8010625a:	e9 15 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106261:	6a 58                	push   $0x58
  jmp alltraps
80106263:	e9 0c f8 ff ff       	jmp    80105a74 <alltraps>
...
8010626a:	6a 59                	push   $0x59
  jmp alltraps
8010626c:	e9 03 f8 ff ff       	jmp    80105a74 <alltraps>
...
80106273:	6a 5a                	push   $0x5a
  jmp alltraps
80106275:	e9 fa f7 ff ff       	jmp    80105a74 <alltraps>
...
8010627c:	6a 5b                	push   $0x5b
  jmp alltraps
8010627e:	e9 f1 f7 ff ff       	jmp    80105a74 <alltraps>
...
80106285:	6a 5c                	push   $0x5c
  jmp alltraps
80106287:	e9 e8 f7 ff ff       	jmp    80105a74 <alltraps>
...
8010628e:	6a 5d                	push   $0x5d
  jmp alltraps
80106290:	e9 df f7 ff ff       	jmp    80105a74 <alltraps>
...
80106297:	6a 5e                	push   $0x5e
  jmp alltraps
80106299:	e9 d6 f7 ff ff       	jmp    80105a74 <alltraps>
...
801062a0:	6a 5f                	push   $0x5f
  jmp alltraps
801062a2:	e9 cd f7 ff ff       	jmp    80105a74 <alltraps>
...
801062a9:	6a 60                	push   $0x60
  jmp alltraps
801062ab:	e9 c4 f7 ff ff       	jmp    80105a74 <alltraps>
...
801062b2:	6a 61                	push   $0x61
  jmp alltraps
801062b4:	e9 bb f7 ff ff       	jmp    80105a74 <alltraps>
...
801062bb:	6a 62                	push   $0x62
  jmp alltraps
801062bd:	e9 b2 f7 ff ff       	jmp    80105a74 <alltraps>
...
801062c4:	6a 63                	push   $0x63
  jmp alltraps
801062c6:	e9 a9 f7 ff ff       	jmp    80105a74 <alltraps>
...
801062cd:	6a 64                	push   $0x64
  jmp alltraps
801062cf:	e9 a0 f7 ff ff       	jmp    80105a74 <alltraps>
...
801062d6:	6a 65                	push   $0x65
  jmp alltraps
801062d8:	e9 97 f7 ff ff       	jmp    80105a74 <alltraps>
...
801062df:	6a 66                	push   $0x66
  jmp alltraps
801062e1:	e9 8e f7 ff ff       	jmp    80105a74 <alltraps>
...
801062e8:	6a 67                	push   $0x67
  jmp alltraps
801062ea:	e9 85 f7 ff ff       	jmp    80105a74 <alltraps>
...
801062f1:	6a 68                	push   $0x68
  jmp alltraps
801062f3:	e9 7c f7 ff ff       	jmp    80105a74 <alltraps>
...
801062fa:	6a 69                	push   $0x69
  jmp alltraps
801062fc:	e9 73 f7 ff ff       	jmp    80105a74 <alltraps>
...
80106303:	6a 6a                	push   $0x6a
  jmp alltraps
80106305:	e9 6a f7 ff ff       	jmp    80105a74 <alltraps>
...
8010630c:	6a 6b                	push   $0x6b
  jmp alltraps
8010630e:	e9 61 f7 ff ff       	jmp    80105a74 <alltraps>
...
80106315:	6a 6c                	push   $0x6c
  jmp alltraps
80106317:	e9 58 f7 ff ff       	jmp    80105a74 <alltraps>
...
8010631e:	6a 6d                	push   $0x6d
  jmp alltraps
80106320:	e9 4f f7 ff ff       	jmp    80105a74 <alltraps>
...
80106327:	6a 6e                	push   $0x6e
  jmp alltraps
80106329:	e9 46 f7 ff ff       	jmp    80105a74 <alltraps>
...
80106330:	6a 6f                	push   $0x6f
  jmp alltraps
80106332:	e9 3d f7 ff ff       	jmp    80105a74 <alltraps>
...
80106339:	6a 70                	push   $0x70
  jmp alltraps
8010633b:	e9 34 f7 ff ff       	jmp    80105a74 <alltraps>
...
80106342:	6a 71                	push   $0x71
  jmp alltraps
80106344:	e9 2b f7 ff ff       	jmp    80105a74 <alltraps>
...
8010634b:	6a 72                	push   $0x72
  jmp alltraps
8010634d:	e9 22 f7 ff ff       	jmp    80105a74 <alltraps>
...
80106354:	6a 73                	push   $0x73
  jmp alltraps
80106356:	e9 19 f7 ff ff       	jmp    80105a74 <alltraps>
...
8010635d:	6a 74                	push   $0x74
  jmp alltraps
8010635f:	e9 10 f7 ff ff       	jmp    80105a74 <alltraps>
...
80106366:	6a 75                	push   $0x75
  jmp alltraps
80106368:	e9 07 f7 ff ff       	jmp    80105a74 <alltraps>
...
8010636f:	6a 76                	push   $0x76
  jmp alltraps
80106371:	e9 fe f6 ff ff       	jmp    80105a74 <alltraps>
...
80106378:	6a 77                	push   $0x77
  jmp alltraps
8010637a:	e9 f5 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106381:	6a 78                	push   $0x78
  jmp alltraps
80106383:	e9 ec f6 ff ff       	jmp    80105a74 <alltraps>
...
8010638a:	6a 79                	push   $0x79
  jmp alltraps
8010638c:	e9 e3 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106393:	6a 7a                	push   $0x7a
  jmp alltraps
80106395:	e9 da f6 ff ff       	jmp    80105a74 <alltraps>
...
8010639c:	6a 7b                	push   $0x7b
  jmp alltraps
8010639e:	e9 d1 f6 ff ff       	jmp    80105a74 <alltraps>
...
801063a5:	6a 7c                	push   $0x7c
  jmp alltraps
801063a7:	e9 c8 f6 ff ff       	jmp    80105a74 <alltraps>
...
801063ae:	6a 7d                	push   $0x7d
  jmp alltraps
801063b0:	e9 bf f6 ff ff       	jmp    80105a74 <alltraps>
...
801063b7:	6a 7e                	push   $0x7e
  jmp alltraps
801063b9:	e9 b6 f6 ff ff       	jmp    80105a74 <alltraps>
...
801063c0:	6a 7f                	push   $0x7f
  jmp alltraps
801063c2:	e9 ad f6 ff ff       	jmp    80105a74 <alltraps>
...
801063c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063ce:	e9 a1 f6 ff ff       	jmp    80105a74 <alltraps>
...
801063d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063da:	e9 95 f6 ff ff       	jmp    80105a74 <alltraps>
...
801063e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063e6:	e9 89 f6 ff ff       	jmp    80105a74 <alltraps>
...
801063ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063f2:	e9 7d f6 ff ff       	jmp    80105a74 <alltraps>
...
801063f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063fe:	e9 71 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106405:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010640a:	e9 65 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106411:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106416:	e9 59 f6 ff ff       	jmp    80105a74 <alltraps>
...
8010641d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106422:	e9 4d f6 ff ff       	jmp    80105a74 <alltraps>
...
80106429:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010642e:	e9 41 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106435:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010643a:	e9 35 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106441:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106446:	e9 29 f6 ff ff       	jmp    80105a74 <alltraps>
...
8010644d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106452:	e9 1d f6 ff ff       	jmp    80105a74 <alltraps>
...
80106459:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010645e:	e9 11 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106465:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010646a:	e9 05 f6 ff ff       	jmp    80105a74 <alltraps>
...
80106471:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106476:	e9 f9 f5 ff ff       	jmp    80105a74 <alltraps>
...
8010647d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106482:	e9 ed f5 ff ff       	jmp    80105a74 <alltraps>
...
80106489:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010648e:	e9 e1 f5 ff ff       	jmp    80105a74 <alltraps>
...
80106495:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010649a:	e9 d5 f5 ff ff       	jmp    80105a74 <alltraps>
...
801064a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064a6:	e9 c9 f5 ff ff       	jmp    80105a74 <alltraps>
...
801064ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064b2:	e9 bd f5 ff ff       	jmp    80105a74 <alltraps>
...
801064b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064be:	e9 b1 f5 ff ff       	jmp    80105a74 <alltraps>
...
801064c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ca:	e9 a5 f5 ff ff       	jmp    80105a74 <alltraps>
...
801064d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064d6:	e9 99 f5 ff ff       	jmp    80105a74 <alltraps>
...
801064dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064e2:	e9 8d f5 ff ff       	jmp    80105a74 <alltraps>
...
801064e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064ee:	e9 81 f5 ff ff       	jmp    80105a74 <alltraps>
...
801064f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064fa:	e9 75 f5 ff ff       	jmp    80105a74 <alltraps>
...
80106501:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106506:	e9 69 f5 ff ff       	jmp    80105a74 <alltraps>
...
8010650d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106512:	e9 5d f5 ff ff       	jmp    80105a74 <alltraps>
...
80106519:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010651e:	e9 51 f5 ff ff       	jmp    80105a74 <alltraps>
...
80106525:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010652a:	e9 45 f5 ff ff       	jmp    80105a74 <alltraps>
...
80106531:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106536:	e9 39 f5 ff ff       	jmp    80105a74 <alltraps>
...
8010653d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106542:	e9 2d f5 ff ff       	jmp    80105a74 <alltraps>
...
80106549:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010654e:	e9 21 f5 ff ff       	jmp    80105a74 <alltraps>
...
80106555:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010655a:	e9 15 f5 ff ff       	jmp    80105a74 <alltraps>
...
80106561:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106566:	e9 09 f5 ff ff       	jmp    80105a74 <alltraps>
...
8010656d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106572:	e9 fd f4 ff ff       	jmp    80105a74 <alltraps>
...
80106579:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010657e:	e9 f1 f4 ff ff       	jmp    80105a74 <alltraps>
...
80106585:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010658a:	e9 e5 f4 ff ff       	jmp    80105a74 <alltraps>
...
80106591:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106596:	e9 d9 f4 ff ff       	jmp    80105a74 <alltraps>
...
8010659d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065a2:	e9 cd f4 ff ff       	jmp    80105a74 <alltraps>
...
801065a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801065ae:	e9 c1 f4 ff ff       	jmp    80105a74 <alltraps>
...
801065b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065ba:	e9 b5 f4 ff ff       	jmp    80105a74 <alltraps>
...
801065c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065c6:	e9 a9 f4 ff ff       	jmp    80105a74 <alltraps>
...
801065cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065d2:	e9 9d f4 ff ff       	jmp    80105a74 <alltraps>
...
801065d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065de:	e9 91 f4 ff ff       	jmp    80105a74 <alltraps>
...
801065e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ea:	e9 85 f4 ff ff       	jmp    80105a74 <alltraps>
...
801065f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065f6:	e9 79 f4 ff ff       	jmp    80105a74 <alltraps>
...
801065fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106602:	e9 6d f4 ff ff       	jmp    80105a74 <alltraps>
...
80106609:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010660e:	e9 61 f4 ff ff       	jmp    80105a74 <alltraps>
...
80106615:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010661a:	e9 55 f4 ff ff       	jmp    80105a74 <alltraps>
...
80106621:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106626:	e9 49 f4 ff ff       	jmp    80105a74 <alltraps>
...
8010662d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106632:	e9 3d f4 ff ff       	jmp    80105a74 <alltraps>
...
80106639:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010663e:	e9 31 f4 ff ff       	jmp    80105a74 <alltraps>
...
80106645:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010664a:	e9 25 f4 ff ff       	jmp    80105a74 <alltraps>
...
80106651:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106656:	e9 19 f4 ff ff       	jmp    80105a74 <alltraps>
...
8010665d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106662:	e9 0d f4 ff ff       	jmp    80105a74 <alltraps>
...
80106669:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010666e:	e9 01 f4 ff ff       	jmp    80105a74 <alltraps>
...
80106675:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010667a:	e9 f5 f3 ff ff       	jmp    80105a74 <alltraps>
...
80106681:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106686:	e9 e9 f3 ff ff       	jmp    80105a74 <alltraps>
...
8010668d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106692:	e9 dd f3 ff ff       	jmp    80105a74 <alltraps>
...
80106699:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010669e:	e9 d1 f3 ff ff       	jmp    80105a74 <alltraps>
...
801066a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066aa:	e9 c5 f3 ff ff       	jmp    80105a74 <alltraps>
...
801066b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066b6:	e9 b9 f3 ff ff       	jmp    80105a74 <alltraps>
...
801066bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066c2:	e9 ad f3 ff ff       	jmp    80105a74 <alltraps>
...
801066c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066ce:	e9 a1 f3 ff ff       	jmp    80105a74 <alltraps>
...
801066d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066da:	e9 95 f3 ff ff       	jmp    80105a74 <alltraps>
...
801066e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066e6:	e9 89 f3 ff ff       	jmp    80105a74 <alltraps>
...
801066ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066f2:	e9 7d f3 ff ff       	jmp    80105a74 <alltraps>
...
801066f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066fe:	e9 71 f3 ff ff       	jmp    80105a74 <alltraps>
...
80106705:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010670a:	e9 65 f3 ff ff       	jmp    80105a74 <alltraps>
...
80106711:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106716:	e9 59 f3 ff ff       	jmp    80105a74 <alltraps>
...
8010671d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106722:	e9 4d f3 ff ff       	jmp    80105a74 <alltraps>
...
80106729:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010672e:	e9 41 f3 ff ff       	jmp    80105a74 <alltraps>
...
80106735:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010673a:	e9 35 f3 ff ff       	jmp    80105a74 <alltraps>
...
80106741:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106746:	e9 29 f3 ff ff       	jmp    80105a74 <alltraps>
...
8010674d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106752:	e9 1d f3 ff ff       	jmp    80105a74 <alltraps>
...
80106759:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010675e:	e9 11 f3 ff ff       	jmp    80105a74 <alltraps>
...
80106765:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010676a:	e9 05 f3 ff ff       	jmp    80105a74 <alltraps>
...
80106771:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106776:	e9 f9 f2 ff ff       	jmp    80105a74 <alltraps>
...
8010677d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106782:	e9 ed f2 ff ff       	jmp    80105a74 <alltraps>
...
80106789:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010678e:	e9 e1 f2 ff ff       	jmp    80105a74 <alltraps>
...
80106795:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010679a:	e9 d5 f2 ff ff       	jmp    80105a74 <alltraps>
...
801067a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067a6:	e9 c9 f2 ff ff       	jmp    80105a74 <alltraps>
...
801067ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067b2:	e9 bd f2 ff ff       	jmp    80105a74 <alltraps>
...
801067b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067be:	e9 b1 f2 ff ff       	jmp    80105a74 <alltraps>
...
801067c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ca:	e9 a5 f2 ff ff       	jmp    80105a74 <alltraps>
...
801067d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067d6:	e9 99 f2 ff ff       	jmp    80105a74 <alltraps>
...
801067dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067e2:	e9 8d f2 ff ff       	jmp    80105a74 <alltraps>
...
801067e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067ee:	e9 81 f2 ff ff       	jmp    80105a74 <alltraps>
...
801067f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067fa:	e9 75 f2 ff ff       	jmp    80105a74 <alltraps>
...
80106801:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106806:	e9 69 f2 ff ff       	jmp    80105a74 <alltraps>
...
8010680d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106812:	e9 5d f2 ff ff       	jmp    80105a74 <alltraps>
...
80106819:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010681e:	e9 51 f2 ff ff       	jmp    80105a74 <alltraps>
...
80106825:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010682a:	e9 45 f2 ff ff       	jmp    80105a74 <alltraps>
...
80106831:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106836:	e9 39 f2 ff ff       	jmp    80105a74 <alltraps>
...
8010683d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106842:	e9 2d f2 ff ff       	jmp    80105a74 <alltraps>
...
80106849:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010684e:	e9 21 f2 ff ff       	jmp    80105a74 <alltraps>
...
80106855:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010685a:	e9 15 f2 ff ff       	jmp    80105a74 <alltraps>
...
80106861:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106866:	e9 09 f2 ff ff       	jmp    80105a74 <alltraps>
...
8010686d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106872:	e9 fd f1 ff ff       	jmp    80105a74 <alltraps>
...
80106879:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010687e:	e9 f1 f1 ff ff       	jmp    80105a74 <alltraps>
...
80106885:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010688a:	e9 e5 f1 ff ff       	jmp    80105a74 <alltraps>
...
80106891:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106896:	e9 d9 f1 ff ff       	jmp    80105a74 <alltraps>
...
8010689d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068a2:	e9 cd f1 ff ff       	jmp    80105a74 <alltraps>
...
801068a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801068ae:	e9 c1 f1 ff ff       	jmp    80105a74 <alltraps>
...
801068b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068ba:	e9 b5 f1 ff ff       	jmp    80105a74 <alltraps>
...
801068c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068c6:	e9 a9 f1 ff ff       	jmp    80105a74 <alltraps>
...
801068cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068d2:	e9 9d f1 ff ff       	jmp    80105a74 <alltraps>
...
801068d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068de:	e9 91 f1 ff ff       	jmp    80105a74 <alltraps>
...
801068e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ea:	e9 85 f1 ff ff       	jmp    80105a74 <alltraps>
...
801068f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068f6:	e9 79 f1 ff ff       	jmp    80105a74 <alltraps>
...
801068fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106902:	e9 6d f1 ff ff       	jmp    80105a74 <alltraps>
...
80106909:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010690e:	e9 61 f1 ff ff       	jmp    80105a74 <alltraps>
...
80106915:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010691a:	e9 55 f1 ff ff       	jmp    80105a74 <alltraps>
...
80106921:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106926:	e9 49 f1 ff ff       	jmp    80105a74 <alltraps>
...
8010692d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106932:	e9 3d f1 ff ff       	jmp    80105a74 <alltraps>
...
80106939:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010693e:	e9 31 f1 ff ff       	jmp    80105a74 <alltraps>
...
80106945:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010694a:	e9 25 f1 ff ff       	jmp    80105a74 <alltraps>
...
80106951:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106956:	e9 19 f1 ff ff       	jmp    80105a74 <alltraps>
...
8010695d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106962:	e9 0d f1 ff ff       	jmp    80105a74 <alltraps>
...
80106969:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010696e:	e9 01 f1 ff ff       	jmp    80105a74 <alltraps>
...
80106975:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010697a:	e9 f5 f0 ff ff       	jmp    80105a74 <alltraps>
...
80106981:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106986:	e9 e9 f0 ff ff       	jmp    80105a74 <alltraps>
...
8010698d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106992:	e9 dd f0 ff ff       	jmp    80105a74 <alltraps>
...
80106999:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010699e:	e9 d1 f0 ff ff       	jmp    80105a74 <alltraps>
...
801069a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069aa:	e9 c5 f0 ff ff       	jmp    80105a74 <alltraps>
...
801069b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069b6:	e9 b9 f0 ff ff       	jmp    80105a74 <alltraps>
...
801069bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069c2:	e9 ad f0 ff ff       	jmp    80105a74 <alltraps>
...
80106a2a:	e8 81 dc ff ff       	call   801046b0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106acd:	68 bc 7d 10 80       	push   $0x80107dbc
...
80106b72:	68 46 77 10 80       	push   $0x80107746
...
80106b83:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b86:	e8 75 cc ff ff       	call   80103800 <cpuid>
...
80106b9a:	c7 80 b8 31 11 80 ff 	movl   $0xffff,-0x7feece48(%eax)
80106ba1:	ff 00 00 
80106ba4:	c7 80 bc 31 11 80 00 	movl   $0xcf9a00,-0x7feece44(%eax)
80106bab:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106bae:	c7 80 c0 31 11 80 ff 	movl   $0xffff,-0x7feece40(%eax)
80106bb5:	ff 00 00 
80106bb8:	c7 80 c4 31 11 80 00 	movl   $0xcf9200,-0x7feece3c(%eax)
80106bbf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106bc2:	c7 80 c8 31 11 80 ff 	movl   $0xffff,-0x7feece38(%eax)
80106bc9:	ff 00 00 
80106bcc:	c7 80 cc 31 11 80 00 	movl   $0xcffa00,-0x7feece34(%eax)
80106bd3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106bd6:	c7 80 d0 31 11 80 ff 	movl   $0xffff,-0x7feece30(%eax)
80106bdd:	ff 00 00 
80106be0:	c7 80 d4 31 11 80 00 	movl   $0xcff200,-0x7feece2c(%eax)
80106be7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106bea:	05 b0 31 11 80       	add    $0x801131b0,%eax
  pd[1] = (uint)p;
...
80106c10:	a1 64 82 11 80       	mov    0x80118264,%eax
{
...
80106c54:	0f 84 c2 00 00 00    	je     80106d1c <switchuvm+0xec>
  pushcli();
80106c5a:	e8 71 d8 ff ff       	call   801044d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c5f:	e8 1c cb ff ff       	call   80103780 <mycpu>
80106c64:	89 c6                	mov    %eax,%esi
80106c66:	e8 15 cb ff ff       	call   80103780 <mycpu>
80106c6b:	89 c7                	mov    %eax,%edi
80106c6d:	e8 0e cb ff ff       	call   80103780 <mycpu>
80106c72:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c75:	83 c7 08             	add    $0x8,%edi
80106c78:	e8 03 cb ff ff       	call   80103780 <mycpu>
...
80106d6f:	e8 3c d9 ff ff       	call   801046b0 <memset>
...
80106da0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106da1:	e9 ba d9 ff ff       	jmp    80104760 <memmove>
    panic("inituvm: more than a page");
80106da6:	83 ec 0c             	sub    $0xc,%esp
80106da9:	68 01 7e 10 80       	push   $0x80107e01
...
80106ecb:	e8 e0 d7 ff ff       	call   801046b0 <memset>
...
80106f0d:	68 39 7e 10 80       	push   $0x80107e39
...
80106f43:	68 51 7e 10 80       	push   $0x80107e51
...
80107080:	e8 2b d6 ff ff       	call   801046b0 <memset>
...
801070eb:	a3 64 82 11 80       	mov    %eax,0x80118264
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010711f:	68 7e 7e 10 80       	push   $0x80107e7e
...
80107170:	e8 eb d5 ff ff       	call   80104760 <memmove>
...
8010729f:	e8 bc d4 ff ff       	call   80104760 <memmove>
    len -= n;
    buf += n;
...
80107301:	b8 c4 a5 10 80       	mov    $0x8010a5c4,%eax
80107306:	b9 7c af 10 80       	mov    $0x8010af7c,%ecx
8010730b:	89 e5                	mov    %esp,%ebp
8010730d:	8b 55 08             	mov    0x8(%ebp),%edx
    /* setting initial seeds to mt[N] using         */
    /* the generator Line 25 of Table 1 in          */
    /* [KNUTH 1981, The Art of Computer Programming */
    /*    Vol. 2 (2nd Ed.), pp102]                  */
    mt[0]= seed & 0xffffffff;
80107310:	89 15 c0 a5 10 80    	mov    %edx,0x8010a5c0
80107316:	eb 0b                	jmp    80107323 <sgenrand+0x23>
80107318:	90                   	nop
80107319:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107320:	83 c0 04             	add    $0x4,%eax
    for (mti=1; mti<N; mti++)
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
80107323:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
80107329:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010732b:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
8010732d:	75 f1                	jne    80107320 <sgenrand+0x20>
8010732f:	c7 05 60 a4 10 80 70 	movl   $0x270,0x8010a460
80107336:	02 00 00 
}
80107339:	5d                   	pop    %ebp
8010733a:	c3                   	ret    
...
80107340:	a1 60 a4 10 80       	mov    0x8010a460,%eax
{
...
80107349:	53                   	push   %ebx
    if (mti >= N) { /* generate N words at one time */
8010734a:	3d 6f 02 00 00       	cmp    $0x26f,%eax
8010734f:	0f 8e f9 00 00 00    	jle    8010744e <genrand+0x10e>
        int kk;

        if (mti == N+1)   /* if sgenrand() has not been called, */
80107355:	3d 71 02 00 00       	cmp    $0x271,%eax
8010735a:	0f 84 fa 00 00 00    	je     8010745a <genrand+0x11a>
80107360:	ba c0 a5 10 80       	mov    $0x8010a5c0,%edx
80107365:	bb 4c a9 10 80       	mov    $0x8010a94c,%ebx
    mt[0]= seed & 0xffffffff;
8010736a:	89 d1                	mov    %edx,%ecx
8010736c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            sgenrand(4357); /* a default initial seed is used   */

        for (kk=0;kk<N-M;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107370:	8b 01                	mov    (%ecx),%eax
80107372:	8b 71 04             	mov    0x4(%ecx),%esi
80107375:	83 c1 04             	add    $0x4,%ecx
80107378:	81 e6 ff ff ff 7f    	and    $0x7fffffff,%esi
8010737e:	25 00 00 00 80       	and    $0x80000000,%eax
80107383:	09 f0                	or     %esi,%eax
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
80107385:	89 c6                	mov    %eax,%esi
80107387:	83 e0 01             	and    $0x1,%eax
8010738a:	d1 ee                	shr    %esi
8010738c:	33 b1 30 06 00 00    	xor    0x630(%ecx),%esi
80107392:	33 34 85 e0 7e 10 80 	xor    -0x7fef8120(,%eax,4),%esi
80107399:	89 71 fc             	mov    %esi,-0x4(%ecx)
        for (kk=0;kk<N-M;kk++) {
8010739c:	39 cb                	cmp    %ecx,%ebx
8010739e:	75 d0                	jne    80107370 <genrand+0x30>
801073a0:	b9 f0 ab 10 80       	mov    $0x8010abf0,%ecx
801073a5:	8d 76 00             	lea    0x0(%esi),%esi
        }
        for (;kk<N-1;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
801073a8:	8b 82 8c 03 00 00    	mov    0x38c(%edx),%eax
801073ae:	8b 9a 90 03 00 00    	mov    0x390(%edx),%ebx
801073b4:	83 c2 04             	add    $0x4,%edx
801073b7:	81 e3 ff ff ff 7f    	and    $0x7fffffff,%ebx
801073bd:	25 00 00 00 80       	and    $0x80000000,%eax
801073c2:	09 d8                	or     %ebx,%eax
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
801073c4:	89 c3                	mov    %eax,%ebx
801073c6:	83 e0 01             	and    $0x1,%eax
801073c9:	d1 eb                	shr    %ebx
801073cb:	33 5a fc             	xor    -0x4(%edx),%ebx
801073ce:	33 1c 85 e0 7e 10 80 	xor    -0x7fef8120(,%eax,4),%ebx
801073d5:	89 9a 88 03 00 00    	mov    %ebx,0x388(%edx)
        for (;kk<N-1;kk++) {
801073db:	39 d1                	cmp    %edx,%ecx
801073dd:	75 c9                	jne    801073a8 <genrand+0x68>
        }
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
801073df:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
801073e4:	8b 0d 7c af 10 80    	mov    0x8010af7c,%ecx
801073ea:	89 c2                	mov    %eax,%edx
801073ec:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
801073f2:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
801073f8:	09 d1                	or     %edx,%ecx
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
801073fa:	89 ca                	mov    %ecx,%edx
801073fc:	83 e1 01             	and    $0x1,%ecx
801073ff:	d1 ea                	shr    %edx
80107401:	33 15 f0 ab 10 80    	xor    0x8010abf0,%edx
80107407:	33 14 8d e0 7e 10 80 	xor    -0x7fef8120(,%ecx,4),%edx
8010740e:	89 15 7c af 10 80    	mov    %edx,0x8010af7c
80107414:	ba 01 00 00 00       	mov    $0x1,%edx

        mti = 0;
    }
  
    y = mt[mti++];
80107419:	89 15 60 a4 10 80    	mov    %edx,0x8010a460
    y ^= TEMPERING_SHIFT_U(y);
8010741f:	89 c2                	mov    %eax,%edx
80107421:	c1 ea 0b             	shr    $0xb,%edx
80107424:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
80107426:	89 d0                	mov    %edx,%eax
80107428:	c1 e0 07             	shl    $0x7,%eax
8010742b:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
80107430:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
80107432:	89 d0                	mov    %edx,%eax
80107434:	c1 e0 0f             	shl    $0xf,%eax
80107437:	25 00 00 c6 ef       	and    $0xefc60000,%eax
8010743c:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_L(y);
8010743e:	89 c2                	mov    %eax,%edx
80107440:	c1 ea 12             	shr    $0x12,%edx
80107443:	31 d0                	xor    %edx,%eax
...
80107445:	5b                   	pop    %ebx
    return y & RAND_MAX;
80107446:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
8010744b:	5e                   	pop    %esi
8010744c:	5d                   	pop    %ebp
8010744d:	c3                   	ret    
8010744e:	8d 50 01             	lea    0x1(%eax),%edx
80107451:	8b 04 85 c0 a5 10 80 	mov    -0x7fef5a40(,%eax,4),%eax
80107458:	eb bf                	jmp    80107419 <genrand+0xd9>
    mt[0]= seed & 0xffffffff;
8010745a:	c7 05 c0 a5 10 80 05 	movl   $0x1105,0x8010a5c0
80107461:	11 00 00 
80107464:	b8 c4 a5 10 80       	mov    $0x8010a5c4,%eax
80107469:	b9 7c af 10 80       	mov    $0x8010af7c,%ecx
8010746e:	ba 05 11 00 00       	mov    $0x1105,%edx
80107473:	eb 06                	jmp    8010747b <genrand+0x13b>
80107475:	8d 76 00             	lea    0x0(%esi),%esi
80107478:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010747b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
80107481:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
80107483:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
80107485:	75 f1                	jne    80107478 <genrand+0x138>
80107487:	e9 d4 fe ff ff       	jmp    80107360 <genrand+0x20>
8010748c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80107490 <random_at_most>:
...
80107491:	31 d2                	xor    %edx,%edx
long random_at_most(long max) {
80107493:	89 e5                	mov    %esp,%ebp
80107495:	56                   	push   %esi
80107496:	53                   	push   %ebx
    num_bins = (unsigned long) max + 1,
80107497:	8b 45 08             	mov    0x8(%ebp),%eax
    bin_size = num_rand / num_bins,
8010749a:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
8010749f:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
801074a2:	89 d8                	mov    %ebx,%eax
801074a4:	f7 f1                	div    %ecx
801074a6:	89 c6                	mov    %eax,%esi
801074a8:	29 d3                	sub    %edx,%ebx
801074aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  do {
   x = genrand();
801074b0:	e8 8b fe ff ff       	call   80107340 <genrand>
  }
  // This is carefully written not to overflow
  while (num_rand - defect <= (unsigned long)x);
801074b5:	39 d8                	cmp    %ebx,%eax
801074b7:	73 f7                	jae    801074b0 <random_at_most+0x20>

  // Truncated division is intentional
  return x/bin_size;
801074b9:	31 d2                	xor    %edx,%edx
801074bb:	f7 f6                	div    %esi
}
801074bd:	5b                   	pop    %ebx
801074be:	5e                   	pop    %esi
801074bf:	5d                   	pop    %ebp
