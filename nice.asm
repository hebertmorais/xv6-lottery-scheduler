...
main(int argc, char **argv) {
  ...
  2a:	e8 71 04 00 00       	call   4a0 <printf>
    exit();
  2f:	e8 fe 02 00 00       	call   332 <exit>
  }
  ...
  4c:	50                   	push   %eax
  4d:	e8 80 03 00 00       	call   3d2 <getpriority>
    if (currentpriority < 0) {
  52:	83 c4 10             	add    $0x10,%esp
  55:	85 c0                	test   %eax,%eax
  57:	78 16                	js     6f <main+0x6f>
  ...
  exit();
  6a:	e8 c3 02 00 00       	call   332 <exit>
      printf(2, "could not get priority\n");
  6f:	50                   	push   %eax
  70:	50                   	push   %eax
  ...
  85:	ff 76 08             	pushl  0x8(%esi)
  88:	e8 33 02 00 00       	call   2c0 <atoi>
    if (newpriority > 31 || newpriority < 0) {
  8d:	83 c4 10             	add    $0x10,%esp
  90:	83 f8 1f             	cmp    $0x1f,%eax
    int newpriority = atoi(argv[2]);
  ...
  ac:	50                   	push   %eax
  ad:	57                   	push   %edi
  ae:	e8 27 03 00 00       	call   3da <setpriority>
    if (oldpriority < 0) {
  ...
  d6:	e8 c5 03 00 00       	call   4a0 <printf>
      exit();
  db:	e8 52 02 00 00       	call   332 <exit>
